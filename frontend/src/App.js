        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold text-gray-900">School29</h1>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-700">
                Добро пожаловать, {user?.full_name} ({user?.role})
              </span>
              <button
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="border-4 border-dashed border-gray-200 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              Панель управления - {user?.role === 'admin' ? 'Администратор' : 
            ...
            {user?.role === 'student' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Расписание</h3>
                  <p className="text-gray-600">Просмотр расписания занятий</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Новости</h3>
                  <p className="text-gray-600">Чтение новостей и предложение статей</p>
                </div>
              </div>
            )}
          </div>
